...
public class MainGrafo2 {
	 ...
	 public static void main(String args[]){
		 ...
		 if (Teste == 1) {
			 ...
			 System.out.println("subgrafo: "+sub);
			 ...
			 GrafoIterator<String> bfsIterator = g.createBFSIterator(g.getVertice("6"));
			 ...
			 GrafoIterator<String> dfsIterator = g.createDFSIterator(g.getVertice("6"));

			 while (dfsIterator.hasMore()) {
				 System.out.println(dfsIterator.getNext());
			 }

//			 Iterator grafoIterator = new GrafoIteratorDFS(g, "6");
//
//			 while (grafoIterator.hasMore()) {
//				 System.out.println(grafoIterator.getNext());
//			 }
